...
The first task of our training engine is <strong>loading our data set</strong>. Attempting to front-load any reasonably sized data set will consume too much memory. Our training engine will quickly run OOM and crash.
...
<figure>
  ...
  <figcaption>Training crop loader</figcaption>
</figure>
